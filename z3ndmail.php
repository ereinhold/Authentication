...
$TARGET_EMAIL = array(EMAIL_NAME."@intellitechaz\.com$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","eric.reinhold@intellitechaz.com");

            /* Help: http://www.tectite.com/fmdoc/site_domain.php */
$SITE_DOMAIN = "intellitechaz.com";           // your website domain name

            /* Help: http://www.tectite.com/fmdoc/set_real_document_root.php */
$SET_REAL_DOCUMENT_ROOT = "C:\inetpub\wwwroot";       // overrides the value set by SetRealDocumentRoot function
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_LOG_OK] = 'OK';
        ...
        // Parameters: none
    $aMessages[MSG_THANKS_PAGE] = 'Thanks!  We\'ve received your request '.
                                  'and, an Intellitech technician will be in '.
                                  'contact with you as soon as they are available. <br>'.
								  '<a href="index.php">Return to Client Portal</a> | <a href="login.php?action=logoff">Logout</a>';
