...
//This is the code for inserting new users into the Accounts Database
        ...
        if (tep_db_num_rows($check_query) < 1) {
          tep_db_query("insert into " . TABLE_ADMINISTRATORS . " (user_name, user_password, company, fullname) values ('" . tep_db_input($username) . "', '" . tep_db_input(tep_encrypt_password($password)) . "','" . tep_db_input($fullname) . "','" . tep_db_input($company) . "')");
...
// Update Tables with Edit Button
        tep_db_query("update " . TABLE_ADMINISTRATORS . " set user_name = '" . tep_db_input($username) . "', fullname = '" . tep_db_input($fullname) . "', company = '" . tep_db_input($company) . "' where id = '" . (int)$HTTP_GET_VARS['aID'] . "'");
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                ...
                <td class="dataTableHeadingContent" align="left"><?php echo "Company Name"; ?></td>
				<td class="dataTableHeadingContent" align="left"><?php echo "Full Name"; ?></td>
                <td class="dataTableHeadingContent" align="right"><?php echo TABLE_HEADING_ACTION; ?>&nbsp;</td>
              </tr>
<?php
  $admins_query = tep_db_query("select id, user_name, company, fullname from " . TABLE_ADMINISTRATORS . " order by user_name");
...
?>
                ...
                <td class="dataTableContent" align="left"><?php echo $admins['company']; ?></td>
				 <td class="dataTableContent" align="left"><?php echo $admins['fullname']; ?></td>
...
<?php
  ...
  switch ($action) {
    case 'new':
	  ...
	  $contents[] = array('text' => '<br />' . TEXT_INFO_COMPANY . '<br />' . tep_draw_input_field('company'));
	  $contents[] = array('text' => '<br />' . TEXT_INFO_FULLNAME . '<br />' . tep_draw_input_field('fullname'));
    ...
    case 'edit':
	  ...
	  $contents[] = array('text' => '<br />' . TEXT_INFO_COMPANY . '<br />' . tep_draw_input_field('company', $aInfo->company));
	  $contents[] = array('text' => '<br />' . TEXT_INFO_FULLNAME . '<br />' . tep_draw_input_field('fullname', $aInfo->fullname));
...
<a href="index.php">Back</a> | <a href="login.php?action=logoff">Logout</a> 