...
//
        if ($actionRecorder->canPerform()) {
          $check_query = tep_db_query("select id, user_name, company, fullname, admin_status, user_password from " . TABLE_ADMINISTRATORS . " where user_name = '" . tep_db_input($username) . "'");
...
//session info
              $admin = array('id' => $check['id'],
							 ...
							 'admin_status' => $check['admin_status'],
							 );
...
<table border="0" width="300px" cellspacing="2" cellpadding="2">
  <tr>
...
?>
        ...
        <td class="pageHeading" align="center"><?php echo tep_draw_form('adminlanguage', FILENAME_DEFAULT, '', 'get') . tep_draw_pull_down_menu('language', $languages_array, $languages_selected, 'onchange="this.form.submit();"') . tep_hide_session_id() . '</form>'; ?></td>
...
<a href="javascript: history.go(-1)">Back</a> | <a href="http://erpc/">ICG Home</a> 